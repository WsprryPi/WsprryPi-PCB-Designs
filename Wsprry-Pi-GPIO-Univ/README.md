...
This design is for the traditional GPIO transmission board.

Open [Wsprry-Pi-GPIO-Univ.kicad_pro](Wsprry-Pi-GPIO-Univ.kicad_pro) in KiCad.
The [schematic PDF](Wsprry-Pi-GPIO-Univ.pdf) is a reference export.
